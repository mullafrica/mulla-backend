...
<body>
    <div class="container">
        ...
        <main>
            ...
            <p style="font-size: 10px;">If you did not initiate this password reset, please reach out to us immediately on <a href="hello@trycomet.app">support@mulla.africa</a></p>
        </main>
        <footer class="footer">
